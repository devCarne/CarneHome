                    ...
                    <ul class="nav">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item dropdown-phone" style="color: black" href="#">전화번호: 010-2078-1158 (클릭 시 복사)</a>
                                <a class="dropdown-item" href="mailto:kms74568@naver.com">이메일: kms74568@naver.com (클릭 시 메일 보내기)</a>
                            </div>
                        </li>
                    </ul>
                </div>
